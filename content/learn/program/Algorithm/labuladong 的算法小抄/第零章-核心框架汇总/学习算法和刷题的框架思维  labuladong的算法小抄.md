...
modified: 45_2022-11-12 19:34:07
tags: [learn/program/algorithm/labuladong/核心框架]
title: 学习算法和刷题的框架思维  labuladong的算法小抄
---
# 学习算法和刷题的框架思维 Labuladong的算法小抄
## 学习算法和刷题的框架思维
...
[动态规划详解](https://labuladong.gitee.io/algo/3/25/69/)说过凑零钱问题，暴力解法就是遍历一棵 N 叉树：
...
再看看回溯算法，后文 [回溯算法详解](https://labuladong.gitee.io/algo/4/31/104/) 干脆直接说了，回溯算法就是个 N 叉树的前后序遍历问题，没有例外。
...
这种思维是很重要的， [动态规划详解](https://labuladong.gitee.io/algo/3/25/69/) 中总结的找状态转移方程的几步流程，有时候按照流程写出解法，可能自己都不知道为啥是对的，反正它就是对了。。。
...
-   [如何 K 个一组反转链表](https://labuladong.gitee.io/algo/2/19/20/)
...
-   [题目不让我干什么，我偏要干什么](https://labuladong.gitee.io/algo/2/21/46/)
