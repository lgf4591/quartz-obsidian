...
modified: 45_2022-11-12 19:27:43
tags: [learn/program/algorithm/labuladong/技巧/暴力搜索]
title: 经典回溯算法：集合划分问题  labuladong的算法小抄
---
...
回溯算法的技巧也不难，前文 [回溯算法框架套路](https://labuladong.gitee.io/algo/4/31/104/) 说过，回溯算法就是穷举一棵决策树的过程，只要在递归之前「做选择」，在递归之后「撤销选择」就行了。

**但是，就算暴力穷举，不同的思路也有优劣之分**。

本文就来看一道非常经典的回溯算法问题，力扣第 698 题「 [划分为k个相等的子集](https://leetcode.cn/problems/partition-to-k-equal-sum-subsets/)」。这道题可以帮你更深刻理解回溯算法的思维，得心应手地写出回溯函数。
...
我们之前 [背包问题之子集划分](https://labuladong.gitee.io/algo/3/27/82/) 写过一次子集划分问题，不过那道题只需要我们把集合划分成两个相等的集合，可以转化成背包问题用动态规划技巧解决。
...
[![](https://labuladong.gitee.io/algo/images/%e9%9b%86%e5%90%88%e5%88%92%e5%88%86/math.png)](https://labuladong.gitee.io/algo/images/%e9%9b%86%e5%90%88%e5%88%92%e5%88%86/math.png)

好，现在我问一个问题，这个排列公式 `P(n, k)` 是如何推导出来的？为了搞清楚这个问题，我需要讲一点组合数学的知识。

排列组合问题的各种变体都可以抽象成「球盒模型」，`P(n, k)` 就可以抽象成下面这个场景：

[![](https://labuladong.gitee.io/algo/images/%e9%9b%86%e5%90%88%e5%88%92%e5%88%86/7.jpeg)](https://labuladong.gitee.io/algo/images/%e9%9b%86%e5%90%88%e5%88%92%e5%88%86/7.jpeg)
...
[![](https://labuladong.gitee.io/algo/images/%e9%9b%86%e5%90%88%e5%88%92%e5%88%86/8.jpeg)](https://labuladong.gitee.io/algo/images/%e9%9b%86%e5%90%88%e5%88%92%e5%88%86/8.jpeg)
...
[![](https://labuladong.gitee.io/algo/images/%e9%9b%86%e5%90%88%e5%88%92%e5%88%86/9.jpeg)](https://labuladong.gitee.io/algo/images/%e9%9b%86%e5%90%88%e5%88%92%e5%88%86/9.jpeg)

你看，两种视角得到两个不同的递归式，但这两个递归式解开的结果都是我们熟知的阶乘形式：

[![](https://labuladong.gitee.io/algo/images/%e9%9b%86%e5%90%88%e5%88%92%e5%88%86/math1.png)](https://labuladong.gitee.io/algo/images/%e9%9b%86%e5%90%88%e5%88%92%e5%88%86/math1.png)
...
前文 [回溯算法框架套路](https://labuladong.gitee.io/algo/4/31/104/) 说过，回溯算法的关键在哪里？
...
[![](https://labuladong.gitee.io/algo/images/%e9%9b%86%e5%90%88%e5%88%92%e5%88%86/5.jpeg)](https://labuladong.gitee.io/algo/images/%e9%9b%86%e5%90%88%e5%88%92%e5%88%86/5.jpeg)

**视角二，如果我们切换到这 `k` 个桶的视角，对于每个桶，都要遍历 `nums` 中的 `n` 个数字，然后选择是否将当前遍历到的数字装进自己这个桶里**。

[![](https://labuladong.gitee.io/algo/images/%e9%9b%86%e5%90%88%e5%88%92%e5%88%86/6.jpeg)](https://labuladong.gitee.io/algo/images/%e9%9b%86%e5%90%88%e5%88%92%e5%88%86/6.jpeg)
...
[![](https://labuladong.gitee.io/algo/images/%e9%9b%86%e5%90%88%e5%88%92%e5%88%86/1.jpeg)](https://labuladong.gitee.io/algo/images/%e9%9b%86%e5%90%88%e5%88%92%e5%88%86/1.jpeg)

现在第一个桶装满了，就开始装第二个桶，算法会装入 `2, 3`：

[![](https://labuladong.gitee.io/algo/images/%e9%9b%86%e5%90%88%e5%88%92%e5%88%86/2.jpeg)](https://labuladong.gitee.io/algo/images/%e9%9b%86%e5%90%88%e5%88%92%e5%88%86/2.jpeg)
...
[![](https://labuladong.gitee.io/algo/images/%e9%9b%86%e5%90%88%e5%88%92%e5%88%86/3.jpeg)](https://labuladong.gitee.io/algo/images/%e9%9b%86%e5%90%88%e5%88%92%e5%88%86/3.jpeg)

现在第一个桶装满了，就开始装第二个桶，算法会装入 `1, 4`：

[![](https://labuladong.gitee.io/algo/images/%e9%9b%86%e5%90%88%e5%88%92%e5%88%86/4.jpeg)](https://labuladong.gitee.io/algo/images/%e9%9b%86%e5%90%88%e5%88%92%e5%88%86/4.jpeg)
...
> [0-1 背包问题](https://labuladong.gitee.io/algo/3/27/81/) 的场景中，有一个背包和若干物品，每个物品有**两个选择**，分别是「装进背包」和「不装进背包」。把原集合 `S` 划分成两个相等子集 `S_1, S_2` 的场景下，`S` 中的每个元素也有**两个选择**，分别是「装进 `S_1`」和「不装进 `S_1`（装进 `S_2`）」，这时候的穷举思路其实和背包问题相同。
...
-   [谁能想到，斗地主也能玩出算法](https://labuladong.gitee.io/algo/4/33/124/)
