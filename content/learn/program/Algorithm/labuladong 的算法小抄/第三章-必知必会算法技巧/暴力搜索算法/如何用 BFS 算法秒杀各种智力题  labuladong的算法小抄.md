...
modified: 45_2022-11-12 19:27:33
tags: [learn/program/algorithm/labuladong/技巧/暴力搜索]
title: 如何用 BFS 算法秒杀各种智力题  labuladong的算法小抄
---
...
[![](https://labuladong.gitee.io/algo/images/sliding_puzzle/1.jpeg)](https://labuladong.gitee.io/algo/images/sliding_puzzle/1.jpeg)

拼图中有一个格子是空的，可以利用这个空着的格子移动其他数字。你需要通过移动这些数字，得到某个特定排列顺序，这样就算赢了。

我小时候还玩过一款叫做「华容道」的益智游戏，也和滑动拼图比较类似：

[![](https://labuladong.gitee.io/algo/images/sliding_puzzle/2.jpeg)](https://labuladong.gitee.io/algo/images/sliding_puzzle/2.jpeg)
...
[![](https://labuladong.gitee.io/algo/images/sliding_puzzle/5.jpeg)](https://labuladong.gitee.io/algo/images/sliding_puzzle/5.jpeg)
...
[![](https://labuladong.gitee.io/algo/images/sliding_puzzle/3.jpeg)](https://labuladong.gitee.io/algo/images/sliding_puzzle/3.jpeg)
...
[![](https://labuladong.gitee.io/algo/images/sliding_puzzle/4.jpeg)](https://labuladong.gitee.io/algo/images/sliding_puzzle/4.jpeg)
...
至此，我们就把这个问题完全转化成标准的 BFS 问题了，借助前文 [BFS 算法框架](https://labuladong.gitee.io/algo/4/31/110/) 的代码框架，直接就可以套出解法代码了：
