...
modified: 45_2022-11-12 19:28:30
tags: [learn/program/algorithm/labuladong/技巧/面试]
title: 烧饼排序算法  labuladong的算法小抄
---
...
[![](https://labuladong.gitee.io/algo/images/pancakeSort/1.jpg)](https://labuladong.gitee.io/algo/images/pancakeSort/1.jpg)

设想一下用锅铲翻转一堆烧饼的情景，其实是有一点限制的，我们每次只能将最上面的若干块饼子翻转：

[![](https://labuladong.gitee.io/algo/images/pancakeSort/2.png)](https://labuladong.gitee.io/algo/images/pancakeSort/2.png)

我们的问题是，**如何使用算法得到一个翻转序列，使得烧饼堆变得有序**？

首先，需要把这个问题抽象，用数组来表示烧饼堆：

[![](https://labuladong.gitee.io/algo/images/pancakeSort/title.png)](https://labuladong.gitee.io/algo/images/pancakeSort/title.png)

如何解决这个问题呢？其实类似上篇文章 [递归反转链表的一部分](https://labuladong.gitee.io/algo/2/19/19/)，这也是需要**递归思想**的。
...
[![](https://labuladong.gitee.io/algo/images/pancakeSort/3.jpg)](https://labuladong.gitee.io/algo/images/pancakeSort/3.jpg)

那么，原问题的规模就可以减小，递归调用 `pancakeSort(A, n-1)` 即可：

[![](https://labuladong.gitee.io/algo/images/pancakeSort/4.jpg)](https://labuladong.gitee.io/algo/images/pancakeSort/4.jpg)
