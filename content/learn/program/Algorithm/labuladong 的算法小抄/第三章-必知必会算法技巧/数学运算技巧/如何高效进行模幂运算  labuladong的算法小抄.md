...
modified: 45_2022-11-12 19:26:35
tags: [learn/program/algorithm/labuladong/技巧/数学运算]
title: 如何高效进行模幂运算  labuladong的算法小抄
---
...
| LeetCode | 力扣 | 难度 |
| --- | --- | --- |
| [372\. Super Pow](https://leetcode.com/problems/super-pow/) | [372\. 超级次方](https://leetcode.cn/problems/super-pow/) | 🟠 |

**———–**

今天来聊一道与数学运算有关的题目，力扣第 372 题「 [超级次方](https://leetcode.cn/problems/super-pow/)」，让你进行巨大的幂运算，然后求余数。
...
[![](https://labuladong.gitee.io/algo/images/superPower/formula1.png)](https://labuladong.gitee.io/algo/images/superPower/formula1.png)
...
[![](https://labuladong.gitee.io/algo/images/superPower/formula2.png)](https://labuladong.gitee.io/algo/images/superPower/formula2.png)
...
| LeetCode | 力扣 |
| --- | --- |
| [50\. Pow(x, n)](https://leetcode.com/problems/powx-n/?show=1) | [50\. Pow(x, n)](https://leetcode.cn/problems/powx-n/?show=1) |
| \- | [剑指 Offer 16. 数值的整数次方](https://leetcode.cn/problems/shu-zhi-de-zheng-shu-ci-fang-lcof/?show=1) |
