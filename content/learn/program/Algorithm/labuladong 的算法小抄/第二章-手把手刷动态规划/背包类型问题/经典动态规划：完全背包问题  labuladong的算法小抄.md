...
modified: 45_2022-11-12 19:31:21
tags: [learn/program/algorithm/labuladong/动态规划/背包问题]
title: 经典动态规划：完全背包问题  labuladong的算法小抄
---
...
| LeetCode | 力扣 | 难度 |
| --- | --- | --- |
| [518\. Coin Change 2](https://leetcode.com/problems/coin-change-2/) | [518\. 零钱兑换 II](https://leetcode.cn/problems/coin-change-2/) | 🟠 |

**———–**

零钱兑换 2 是另一种典型背包问题的变体，我们前文已经讲了 [经典动态规划：0-1 背包问题](https://labuladong.gitee.io/algo/3/27/81/) 和 [背包问题变体：相等子集分割](https://labuladong.gitee.io/algo/3/27/82/)。
...
> PS：至于零钱兑换 I，在我们前文 [动态规划套路详解](https://labuladong.gitee.io/algo/3/25/69/) 写过。
...
注意，我们这个问题的特殊点在于物品的数量是无限的，所以这里和之前写的 [0-1 背包问题](https://labuladong.gitee.io/algo/3/27/81/) 文章有所不同。
...
而且，我们通过观察可以发现，`dp` 数组的转移只和 `dp[i][..]` 和 `dp[i-1][..]` 有关，所以可以使用前文讲的 [动态规划空间压缩技巧](https://labuladong.gitee.io/algo/3/25/73/)，进一步降低算法的空间复杂度：
...
-   [背包问题变体之子集分割](https://labuladong.gitee.io/algo/3/27/82/)
