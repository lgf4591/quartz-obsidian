...
modified: 45_2022-11-12 19:31:07
tags: [learn/program/algorithm/labuladong/动态规划/背包问题]
title: 动态规划和回溯算法到底谁是谁爹？  labuladong的算法小抄
---
...
[![](https://labuladong.gitee.io/algo/images/targetSum/1.jpg)](https://labuladong.gitee.io/algo/images/targetSum/1.jpg)
...
任何算法的核心都是穷举，回溯算法就是一个暴力穷举算法，前文 [回溯算法解题框架](https://labuladong.gitee.io/algo/4/31/104/) 就写了回溯算法框架：
...
以上回溯算法可以解决这个问题，时间复杂度为 `O(2^N)`，`N` 为 `nums` 的大小。这个复杂度怎么算的？回忆前文 [学习数据结构和算法的框架思维](https://labuladong.gitee.io/algo/1/2/)，发现这个回溯算法就是个二叉树的遍历问题：
...
前文 [动态规划之编辑距离](https://labuladong.gitee.io/algo/3/26/75/) 说了一种一眼看出重叠子问题的方法，先抽象出递归框架：
...
类似的子集划分问题我们前文 [经典背包问题：子集划分](https://labuladong.gitee.io/algo/3/27/82/) 讲过，现在实现这么一个函数：
...
-   [分治算法：运算优先级](https://labuladong.gitee.io/algo/4/33/122/)
...
| LeetCode | 力扣 |
| --- | --- |
| \- | [剑指 Offer II 102. 加减的目标值](https://leetcode.cn/problems/YaVDxD/?show=1) |
