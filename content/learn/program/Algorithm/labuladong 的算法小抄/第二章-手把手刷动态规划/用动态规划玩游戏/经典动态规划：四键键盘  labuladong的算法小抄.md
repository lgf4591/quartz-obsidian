...
modified: 45_2022-11-12 19:30:46
tags: [learn/program/algorithm/labuladong/动态规划/游戏]
title: 经典动态规划：四键键盘  labuladong的算法小抄
---
...
力扣第 651 题「 [四键键盘](https://leetcode.cn/problems/4-keys-keyboard/)」很有意思，而且可以明显感受到：对 `dp` 数组的不同定义需要完全不同的逻辑，从而产生完全不同的解法。
...
[![](https://labuladong.gitee.io/algo/images/4keyboard/1.jpg)](https://labuladong.gitee.io/algo/images/4keyboard/1.jpg)
