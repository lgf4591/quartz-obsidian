...
modified: 45_2022-11-12 19:32:06
tags: [learn/program/algorithm/labuladong/common]
title: Linux 的进程-线程-文件描述符是什么  labuladong的算法小抄
---
# Linux 的进程-线程-文件描述符是什么 Labuladong的算法小抄
...
[![](https://labuladong.gitee.io/algo/images/linuxProcess/1.jpg)](https://labuladong.gitee.io/algo/images/linuxProcess/1.jpg)
...
[![](https://labuladong.gitee.io/algo/images/linuxProcess/2.jpg)](https://labuladong.gitee.io/algo/images/linuxProcess/2.jpg)
...
[![](https://labuladong.gitee.io/algo/images/linuxProcess/3.jpg)](https://labuladong.gitee.io/algo/images/linuxProcess/3.jpg)

明白了这个原理，**输入重定向**就很好理解了，程序想读取数据的时候就会去 `files[0]` 读取，所以我们只要把 `files[0]` 指向一个文件，那么程序就会从这个文件中读取数据，而不是从键盘：

[![](https://labuladong.gitee.io/algo/images/linuxProcess/5.jpg)](https://labuladong.gitee.io/algo/images/linuxProcess/5.jpg)

同理，**输出重定向**就是把 `files[1]` 指向一个文件，那么程序的输出就不会写入到显示器，而是写入到这个文件中：

[![](https://labuladong.gitee.io/algo/images/linuxProcess/4.jpg)](https://labuladong.gitee.io/algo/images/linuxProcess/4.jpg)

错误重定向也是一样的，就不再赘述。

**管道符**其实也是异曲同工，把一个进程的输出流和另一个进程的输入流接起一条「管道」，数据就在其中传递，不得不说这种设计思想真的很优美：

[![](https://labuladong.gitee.io/algo/images/linuxProcess/6.jpg)](https://labuladong.gitee.io/algo/images/linuxProcess/6.jpg)
...
[![](https://labuladong.gitee.io/algo/images/linuxProcess/7.jpg)](https://labuladong.gitee.io/algo/images/linuxProcess/7.jpg)

[![](https://labuladong.gitee.io/algo/images/linuxProcess/8.jpg)](https://labuladong.gitee.io/algo/images/linuxProcess/8.jpg)
...
-   [关于 Linux shell 你必须知道的](https://labuladong.gitee.io/algo/5/37/)
