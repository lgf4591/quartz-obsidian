...
modified: 45_2022-11-12 19:32:16
tags: [learn/program/algorithm/labuladong/common]
title: 一文看懂 session 和 cookie  labuladong的算法小抄
---
# 一文看懂 Session 和 Cookie Labuladong的算法小抄
...
[![](https://labuladong.gitee.io/algo/images/session/1.png)](https://labuladong.gitee.io/algo/images/session/1.png)

在这之后，浏览器的请求中的 `Cookie` 字段就带上了这两个 cookie：

[![](https://labuladong.gitee.io/algo/images/session/2.png)](https://labuladong.gitee.io/algo/images/session/2.png)
...
[![](https://labuladong.gitee.io/algo/images/session/3.png)](https://labuladong.gitee.io/algo/images/session/3.png)
...
[![](https://labuladong.gitee.io/algo/images/session/4.jpg)](https://labuladong.gitee.io/algo/images/session/4.jpg)
...
> PS：关于 LRU 算法的奥妙，参见前文 [LRU 算法详解](https://labuladong.gitee.io/algo/2/23/59/)。
