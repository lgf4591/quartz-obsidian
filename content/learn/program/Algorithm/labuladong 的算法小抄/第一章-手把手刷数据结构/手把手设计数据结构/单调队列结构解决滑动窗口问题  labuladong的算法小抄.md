...
modified: 45_2022-11-12 19:25:35
tags: [learn/program/algorithm/labuladong/数据结构]
title: 单调队列结构解决滑动窗口问题  labuladong的算法小抄
---
...
前文用 [单调栈解决三道算法问题](https://labuladong.gitee.io/algo/2/23/63/) 介绍了单调栈这种特殊数据结构，本文写一个类似的数据结构「单调队列」。
...
「单调队列」这个数据结构主要用来辅助解决滑动窗口相关的问题，前文 [滑动窗口核心框架](https://labuladong.gitee.io/algo/2/20/27/) 把滑动窗口算法作为双指针技巧的一部分进行了讲解，但有些稍微复杂的滑动窗口问题不能只靠两个指针来解决，需要上更先进的数据结构。

比方说，你注意看前文 [滑动窗口核心框架](https://labuladong.gitee.io/algo/2/20/27/) 讲的几道题目，每当窗口扩大（`right++`）和窗口缩小（`left++`）时，你单凭移出和移入窗口的元素即可决定是否更新答案。
...
[![](https://labuladong.gitee.io/algo/images/%e5%8d%95%e8%b0%83%e9%98%9f%e5%88%97/window.png)](https://labuladong.gitee.io/algo/images/%e5%8d%95%e8%b0%83%e9%98%9f%e5%88%97/window.png)
...
[![](https://labuladong.gitee.io/algo/images/%e5%8d%95%e8%b0%83%e9%98%9f%e5%88%97/1.png)](https://labuladong.gitee.io/algo/images/%e5%8d%95%e8%b0%83%e9%98%9f%e5%88%97/1.png)
...
[![](https://labuladong.gitee.io/algo/images/%e5%8d%95%e8%b0%83%e9%98%9f%e5%88%97/3.png)](https://labuladong.gitee.io/algo/images/%e5%8d%95%e8%b0%83%e9%98%9f%e5%88%97/3.png)
...
[![](https://labuladong.gitee.io/algo/images/%e5%8d%95%e8%b0%83%e9%98%9f%e5%88%97/2.png)](https://labuladong.gitee.io/algo/images/%e5%8d%95%e8%b0%83%e9%98%9f%e5%88%97/2.png)
...
这里就用到了 [算法时空复杂度分析使用手册](https://labuladong.gitee.io/algo/1/16/) 中讲到的摊还分析：
