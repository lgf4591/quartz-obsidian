...
modified: 45_2022-11-12 19:23:27
tags: [learn/program/algorithm/labuladong/数据结构/图]
title: 环检测及拓扑排序算法  labuladong的算法小抄
---
# 环检测及拓扑排序算法 Labuladong的算法小抄
## 环检测及拓扑排序算法
...
不过以我的经验呢，像网络流这种问题，你又不是打竞赛的，没时间的话就没必要学了；像 [最小生成树](https://labuladong.gitee.io/algo/2/22/55/) 和 [最短路径问题](https://labuladong.gitee.io/algo/2/22/56/)，虽然从刷题的角度用到的不多，但它们属于经典算法，学有余力可以掌握一下；像 [二分图判定](https://labuladong.gitee.io/algo/2/22/52/)、拓扑排序这一类，属于比较基本且有用的算法，应该比较熟练地掌握。
...
我们前文 [回溯算法核心套路详解](https://labuladong.gitee.io/algo/4/31/104/) 说过，你可以把递归函数看成一个在递归树上游走的指针，这里也是类似的：
...
其实 BFS 算法借助 `indegree` 数组记录每个节点的「入度」，也可以实现这两个算法。不熟悉 BFS 算法的读者可阅读前文 [BFS 算法核心框架](https://labuladong.gitee.io/algo/4/31/110/)。
