...
modified: 45_2022-11-12 19:22:48
tags: [learn/program/algorithm/labuladong/数据结构/图]
title: Dijkstra 算法模板及应用  labuladong的算法小抄
---
# Dijkstra 算法模板及应用 Labuladong的算法小抄
...
比如， [东哥手把手带你刷二叉树（总纲）](https://labuladong.gitee.io/algo/2/21/36/) 中说二叉树非常重要，你把这个结构掌握了，就会发现 [动态规划](https://labuladong.gitee.io/algo/3/25/69/)， [分治算法](https://labuladong.gitee.io/algo/4/33/122/)， [回溯（DFS）算法](https://labuladong.gitee.io/algo/4/31/104/)， [BFS 算法框架](https://labuladong.gitee.io/algo/4/31/110/)， [Union-Find 并查集算法](https://labuladong.gitee.io/algo/2/22/53/)， [二叉堆实现优先级队列](https://labuladong.gitee.io/algo/2/23/65/) 就是把二叉树翻来覆去的运用。
...
前文 [图论第一期：遍历基础](https://labuladong.gitee.io/algo/2/22/50/) 说过「图」这种数据结构的基本实现，图中的节点一般就抽象成一个数字（索引），图的具体实现一般是「邻接矩阵」或者「邻接表」。
...
前文 [图论第二期：拓扑排序](https://labuladong.gitee.io/algo/2/22/51/) 告诉你，我们用邻接表的场景更多，结合上图，一幅图可以用如下 Java 代码表示：
...
如果对 BFS 算法不熟悉，可以看前文 [BFS 算法框架](https://labuladong.gitee.io/algo/4/31/110/)，这里只是为了让你做个对比，所谓 BFS 算法，就是把算法问题抽象成一幅「无权图」，然后继续玩二叉树层级遍历那一套罢了。
...
[![](https://labuladong.gitee.io/algo/images/dijkstra/2.jpeg)](https://labuladong.gitee.io/algo/images/dijkstra/2.jpeg)
...
[![](https://labuladong.gitee.io/algo/images/dijkstra/3.jpeg)](https://labuladong.gitee.io/algo/images/dijkstra/3.jpeg)
...
[![](https://labuladong.gitee.io/algo/images/dijkstra/4.jpeg)](https://labuladong.gitee.io/algo/images/dijkstra/4.jpeg)
...
所以我们使用 `PriorityQueue` 作为队列，让 `distFromStart` 的值较小的节点排在前面，这就类似我们之前讲 [贪心算法](https://labuladong.gitee.io/algo/3/29/102/) 说到的贪心思路，可以很大程度上优化算法的效率。
...
[![](https://labuladong.gitee.io/algo/images/dijkstra/title1.jpg)](https://labuladong.gitee.io/algo/images/dijkstra/title1.jpg)
...
[![](https://labuladong.gitee.io/algo/images/dijkstra/title2.jpg)](https://labuladong.gitee.io/algo/images/dijkstra/title2.jpg)
...
[![](https://labuladong.gitee.io/algo/images/dijkstra/title3.jpg)](https://labuladong.gitee.io/algo/images/dijkstra/title3.jpg)
...
首先关于有向图和无向图，前文 [图算法基础](https://labuladong.gitee.io/algo/2/22/50/) 说过，无向图本质上可以认为是「双向图」，从而转化成有向图。
...
其实后文 [毕业旅行省钱算法](https://labuladong.gitee.io/algo/3/28/89/) 中讲过限制之下的最小路径问题，当时是使用动态规划思路解决的，但文末也给了 Dijkstra 算法代码，仅仅在本文模板的基础上做了一些变换，你理解本文后可以对照着去看看那道题目。
...
-   [二分图判定算法](https://labuladong.gitee.io/algo/2/22/52/)
