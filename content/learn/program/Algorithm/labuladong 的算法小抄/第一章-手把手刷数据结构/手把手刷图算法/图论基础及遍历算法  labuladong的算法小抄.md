...
modified: 45_2022-11-12 19:23:11
tags: [learn/program/algorithm/labuladong/数据结构/图]
title: 图论基础及遍历算法  labuladong的算法小抄
---
# 图论基础及遍历算法 Labuladong的算法小抄
## 图论基础及遍历算法
...
另外，你应该注意到了，这个 `onPath` 数组的操作很像前文 [回溯算法核心套路](https://labuladong.gitee.io/algo/4/31/104/) 中做「做选择」和「撤销选择」，区别在于位置：回溯算法的「做选择」和「撤销选择」在 for 循环里面，而对 `onPath` 数组的操作在 for 循环外面。

为什么有这个区别呢？这就是前文 [回溯算法核心套路](https://labuladong.gitee.io/algo/4/31/104/) 中讲到的回溯算法和 DFS 算法的区别所在：回溯算法关注的不是节点，而是树枝。不信你看前文画的回溯树，我们需要在「树枝」上做选择和撤销选择：
...
-   [众里寻他千百度：名流问题](https://labuladong.gitee.io/algo/2/22/57/)
