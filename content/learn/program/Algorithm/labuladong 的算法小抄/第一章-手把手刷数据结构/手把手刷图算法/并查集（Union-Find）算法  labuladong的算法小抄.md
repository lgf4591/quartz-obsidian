...
modified: 45_2022-11-12 19:23:17
tags: [learn/program/algorithm/labuladong/数据结构/图]
title: 并查集（Union-Find）算法  labuladong的算法小抄
---
# 并查集（Union-Find）算法 Labuladong的算法小抄
...
[![](https://labuladong.gitee.io/algo/images/unionfind/1.jpg)](https://labuladong.gitee.io/algo/images/unionfind/1.jpg)
...
[![](https://labuladong.gitee.io/algo/images/unionfind/2.jpg)](https://labuladong.gitee.io/algo/images/unionfind/2.jpg)
...
[![](https://labuladong.gitee.io/algo/images/unionfind/3.jpg)](https://labuladong.gitee.io/algo/images/unionfind/3.jpg)
...
[![](https://labuladong.gitee.io/algo/images/unionfind/4.jpg)](https://labuladong.gitee.io/algo/images/unionfind/4.jpg)
...
[![](https://labuladong.gitee.io/algo/images/unionfind/5.jpg)](https://labuladong.gitee.io/algo/images/unionfind/5.jpg)
...
[![](https://labuladong.gitee.io/algo/images/unionfind/6.jpg)](https://labuladong.gitee.io/algo/images/unionfind/6.jpg)
...
[![](https://labuladong.gitee.io/algo/images/unionfind/7.jpg)](https://labuladong.gitee.io/algo/images/unionfind/7.jpg)
...
[![](https://labuladong.gitee.io/algo/images/unionfind/8.jpg)](https://labuladong.gitee.io/algo/images/unionfind/8.jpg)
...
[![](https://labuladong.gitee.io/algo/images/unionfind/9.gif)](https://labuladong.gitee.io/algo/images/unionfind/9.gif)
...
[![](https://labuladong.gitee.io/algo/images/unionfind/10.jpeg)](https://labuladong.gitee.io/algo/images/unionfind/10.jpeg)

比起第一种路径压缩，显然这种方法压缩得更彻底，直接把一整条树枝压平，一点意外都没有。就算一些极端情况下产生了一棵比较高的树，只要一次路径压缩就能大幅降低树高，从 [摊还分析](https://labuladong.gitee.io/algo/1/16/) 的角度来看，所有操作的平均时间复杂度依然是 O(1)，所以从效率的角度来说，推荐你使用这种路径压缩算法。
...
[![](https://labuladong.gitee.io/algo/images/unionfind%e5%ba%94%e7%94%a8/2.jpg)](https://labuladong.gitee.io/algo/images/unionfind%e5%ba%94%e7%94%a8/2.jpg)

> PS：这让我想起小时候玩的棋类游戏「黑白棋」，只要你用两个棋子把对方的棋子夹在中间，对方的子就被替换成你的子。可见，占据四角的棋子是无敌的，与其相连的边棋子也是无敌的（无法被夹掉）。

其实这个问题应该归为 [岛屿系列问题](https://labuladong.gitee.io/algo/4/31/107/) 使用 DFS 算法解决：
...
[![](https://labuladong.gitee.io/algo/images/unionfind%e5%ba%94%e7%94%a8/3.jpg)](https://labuladong.gitee.io/algo/images/unionfind%e5%ba%94%e7%94%a8/3.jpg)
...
最后，Union-Find 算法也会在一些其他经典图论算法中用到，比如判断「图」和「树」，以及最小生成树的计算，详情见 [Kruskal 最小生成树算法](https://labuladong.gitee.io/algo/2/22/54/)。
...
-   [一文秒杀所有岛屿题目](https://labuladong.gitee.io/algo/4/31/107/)
