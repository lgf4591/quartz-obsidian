...
modified: 45_2022-11-12 19:24:35
tags: [learn/program/algorithm/labuladong/数据结构/数组]
title: 田忌赛马背后的算法决策  labuladong的算法小抄
---
# 田忌赛马背后的算法决策 Labuladong的算法小抄
## 田忌赛马背后的算法决策
...
同时，最终的解法还用到前文 [双指针技巧汇总](https://labuladong.gitee.io/algo/2/20/23/) 总结的双指针算法模板，用以处理「送人头」的情况：
